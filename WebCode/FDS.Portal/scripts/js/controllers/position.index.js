System.register(["./base", "../services/api", "lodash"], function (exports_1, context_1) {
    ...
    var base_1, webapi, lodash_1, PositionIndexCtrl;
    return {
        setters: [
            function (base_1_1) {
                base_1 = base_1_1;
        ...
        execute: function () {
            PositionIndexCtrl = /** @class */ (function (_super) {
                __extends(PositionIndexCtrl, _super);
                function PositionIndexCtrl($scope, $http, $q, $swal, $timeout, $state, $stateParams, principal, $rootScope, $uibModal, $location, $urlService, $notify, $i18next, api, validateFileSize, Upload) {
                ...
                PositionIndexCtrl.prototype.init = function () {
                ...
                // #region 查询分页
                PositionIndexCtrl.prototype.pageChanged = function () {
                    return __awaiter(this, void 0, void 0, function () {
                ...
                PositionIndexCtrl.prototype.showMemberModel = function () {
                    return __awaiter(this, void 0, void 0, function () {
                        var _this = this;
                        return __generator(this, function (_a) {
                            this.$uibModal.open({
                ...
                PositionIndexCtrl.prototype.openMemberModal = function (l) {
                    return __awaiter(this, void 0, void 0, function () {
                        var _this = this;
                        return __generator(this, function (_a) {
                            this.$uibModal.open({
                ...
                return PositionIndexCtrl;
            }(base_1.default));
            exports_1("PositionIndexCtrl", PositionIndexCtrl);
        }
    };
});
