System.register(["./base", "../services/api", "lodash"], function (exports_1, context_1) {
    ...
    var base_1, webapi, lodash_1, InterviewIndexCtrl;
    return {
        setters: [
            function (base_1_1) {
                base_1 = base_1_1;
        ...
        execute: function () {
            InterviewIndexCtrl = /** @class */ (function (_super) {
                __extends(InterviewIndexCtrl, _super);
                function InterviewIndexCtrl($scope, $http, $q, $swal, $timeout, $state, $stateParams, principal, $rootScope, $uibModal, $location, $urlService, $notify, $i18next, api, validateFileSize, Upload) {
                ...
                InterviewIndexCtrl.prototype.init = function () {
                ...
                // #region 查询分页
                InterviewIndexCtrl.prototype.pageChanged = function () {
                    return __awaiter(this, void 0, void 0, function () {
                        var scope, query, query_1, membersClient, dataSource, err_1;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    scope = this.$scope;
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, membersClient.getMembersAll(scope.pageIndex, scope.pageSize, query_1.name, query_1.phone)];
                                case 2:
                                    dataSource = _a.sent();
                ...
                InterviewIndexCtrl.prototype.showMemberModel = function () {
                    return __awaiter(this, void 0, void 0, function () {
                        var _this = this;
                        return __generator(this, function (_a) {
                            this.$uibModal.open({
                ...
                InterviewIndexCtrl.prototype.openMemberModal = function (l) {
                    return __awaiter(this, void 0, void 0, function () {
                        var _this = this;
                        return __generator(this, function (_a) {
                            this.$uibModal.open({
                ...
                return InterviewIndexCtrl;
            }(base_1.default));
            exports_1("InterviewIndexCtrl", InterviewIndexCtrl);
        }
    };
});
//# sourceMappingURL=interview.index.js.map