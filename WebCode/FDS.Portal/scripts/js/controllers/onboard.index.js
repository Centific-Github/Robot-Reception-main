System.register(["./base", "../services/api", "lodash"], function (exports_1, context_1) {
    ...
    var base_1, webapi, lodash_1, OnboardIndexCtrl;
    return {
        setters: [
            function (base_1_1) {
                base_1 = base_1_1;
        ...
        execute: function () {
            OnboardIndexCtrl = /** @class */ (function (_super) {
                __extends(OnboardIndexCtrl, _super);
                function OnboardIndexCtrl($scope, $http, $q, $swal, $timeout, $state, $stateParams, principal, $rootScope, $uibModal, $location, $urlService, $notify, $i18next, api, validateFileSize, Upload) {
                ...
                OnboardIndexCtrl.prototype.init = function () {
                ...
                // #region 查询分页
                OnboardIndexCtrl.prototype.pageChanged = function () {
                    return __awaiter(this, void 0, void 0, function () {
                ...
                OnboardIndexCtrl.prototype.showMemberModel = function () {
                    return __awaiter(this, void 0, void 0, function () {
                        var _this = this;
                        return __generator(this, function (_a) {
                            this.$uibModal.open({
                ...
                OnboardIndexCtrl.prototype.openMemberModal = function (l) {
                    return __awaiter(this, void 0, void 0, function () {
                        var _this = this;
                        return __generator(this, function (_a) {
                            this.$uibModal.open({
                ...
                return OnboardIndexCtrl;
            }(base_1.default));
            exports_1("OnboardIndexCtrl", OnboardIndexCtrl);
        }
    };
});
//# sourceMappingURL=onboard.index.js.map